...
class OrderPagesLocators:
    ...
    CHECKBOX_BLACK = By.XPATH, './/input[starts-with(@class, "Checkbox_Input") and @id="black"]' # выбор чёрного цвета самоката
    CHECKBOX_GREY = By.XPATH, './/input[starts-with(@class, "Checkbox_Input") and @id="grey"]' # выбор серого цвета самоката
